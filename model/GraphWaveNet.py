...
class gwnet(nn.Module):
    def __init__(self, device, num_nodes, dropout=0.0, supports=None, gcn_bool=True, addaptadj=True, aptinit=None,
                 in_dim=2, out_dim=12,
                 residual_channels=32, dilation_channels=32, skip_channels=256, end_channels=512, kernel_size=2,
                 blocks=4, layers=2):
...
def load_adj(pkl_filename, adjtype):
    ...
    adj_mx = pd.read_csv(pkl_filename).values[:, 1:]
...
def main():
    ...
    from Param_GraphWaveNet import ADJPATH
